...
function showExportLanguageDialog(callback) {
    ...
    if (currentLangDisplay) {
        ...
        currentLangDisplay.innerHTML = `<span class="flag">${flag}</span> ${name}`;
    }
    ...
    return new Promise((resolve) => {
        ...
        if (existingName) {
            ...
            if (existingLangName) {
                ...
                const flag = languageFlags[params.detectedLang] || params.detectedLang.toUpperCase();
        ...
        if (langNameEl) {
            ...
            langNameEl.innerHTML = `<span class="flag">${flag}</span> ${name}`;
        }
