...
**[Start using it now.](https://mocklist.app)**

![App Store Screenshot Generator](img/screenshot-generator.png)

[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)

> Built by [maikover](https://mocklist.app)
...
Visit **[mocklist.app](https://mocklist.app)** to use the tool directly in your browser. No installation needed!
...
docker run -d -p 8080:80 ghcr.io/maikover/mocklist:latest
...
Built by [maikover](https://github.com/maikover) — MOCKLIST App Store Screenshot Generator.
