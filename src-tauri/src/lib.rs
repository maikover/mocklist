...
pub fn run() {
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            #[cfg(target_os = "macos")]
            let app_menu = {
                SubmenuBuilder::new(handle, "mocklist")
                    .about(None)
                    .separator()
                    .item(&settings_item)
                    .separator()
            ...
            let visit_website =
                MenuItemBuilder::with_id("visit-website", "Visit mocklist.app").build(handle)?;
                ...
                match id {
                    ...
                    "documentation" => {
                        let _ = tauri_plugin_opener::open_url(
                            "https://github.com/maikover/mocklist",
                            None::<&str>,
                        );
                    }
                    "report-issue" => {
                        let _ = tauri_plugin_opener::open_url(
                            "https://github.com/maikover/mocklist/issues",
                            None::<&str>,
                        );
                    }
                    "visit-website" => {
